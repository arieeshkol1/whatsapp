...
def call_bedrock_agent(
    input_text: Optional[str] = None, *, session_id: Optional[str] = None
) -> str:
    ...
    We continue to support that calling convention while allowing newer
    keyword-based invocations so Lambda deployments that still pass the
    argument positionally remain functional.
    """
